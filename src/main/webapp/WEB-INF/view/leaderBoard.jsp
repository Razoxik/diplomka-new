        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <form:form method="POST" action="${leaderboardUrl}" modelAttribute="challengeModel"><%----%>
                        <form:select path="gameId" cssClass="form-control selectpicker" id="exampleFormControlSelect1" onchange="this.form.submit()">
                            <c:forEach items="${games}" var="game" varStatus="status">
                                <form:option value="${status.current}"
